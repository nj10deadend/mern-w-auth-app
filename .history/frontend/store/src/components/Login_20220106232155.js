...
function Login () {
    ...
    const {currentUser, setCurrentUser, jwtToken, setJwtToken} = useContext(UserDataContext);
    ...
    // const {value2, value3} = useContext(UserDataContext);
    // console.log({value1});
    // const [currentUser, setCurrentUser] = value1;
    // console.log(currentUser);
    // const [authChecked, setAuthChecked] = value2;
    // console.l0g(authChecked);
    // const [jwtToken, setJwtToken] = value3;
    // console.log(jwtToken);
