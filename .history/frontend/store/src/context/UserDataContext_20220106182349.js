...
export const UserProvider = ({children}) => {
    ...
    return (
        ...
        <UserDataContext.Provider currentUser={currentUser} 
        setCurrentUser={setCurrentUser} authChecked={authChecked} 
        setAuthChecked={setAuthChecked} jwtToken={jwtToken} setJwtToken={jwtToken}>
